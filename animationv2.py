...
class Simulation:
    ...
    def run(self):
        ...
        ani = FuncAnimation(self.fig, self.update_plot, frames=range(1, self.rounds+1), init_func=self.init_plot, repeat=False)
        plt.show()
    ...
    def init_plot(self):
        ...
        self.player_scatter = self.ax.scatter([], [], c='blue', label='Players', marker='o')
        self.ax.legend()
        self.ax.grid()
